...
export const CATEGORIES: Category[] = [
  {
    ...
    items: ITEMS.filter((product) => product.category.slug === "laptops"),
  },
  {
    name: "Phones",
    slug: "phones",
    ...
    items: ITEMS.filter((product) => product.category.slug === "phones"),
  },
  {
    name: "Gaming",
    slug: "gaming",
    ...
    items: ITEMS.filter((product) => product.category.slug === "gaming"),
  },
  {
    name: "Accessories",
    slug: "accessories",
